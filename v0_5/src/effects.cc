 ...
 *   <2>     20.03.02       ALX             direct_effect() not overrides the monster that kills you
 *                                          and says the cause of the spell that kills you.
 *
 *    <1>     -/--/--        LRH             Created
 */
...
void direct_effect(struct bolt &pbolt)
{
    ...
    case DMNBM_HELLFIRE:
        ...
        pbolt.thrower=KILLED_BY_HELLFIRE;
        pbolt.isBeam = false;
    ...
    case DMNBM_SMITING:
        ...
        //alex:20.03.02
        ouch(damage_taken, pbolt.beam_source, KILLED_BY_SMITING);
        break;
    ...
    //Only used by smitting. Removed {alex:20.03.02}
...
//alex:26.02.03
void random_uselessness(unsigned char ru, char sc_read_2=-1)
{
    char wc[30];
    ...
    case 1:
        mpr("You feel the gods looking over you!");
        break;
