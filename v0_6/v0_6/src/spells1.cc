 ...
 *
 *     <5>      21.03.02       alx             confusing_touch use your_hand()
 *
 *
...
void cast_confusing_touch(int power)
{
        ...
        /*
     Use of your_hands() to retrieve the correct name for "hands"
     Alex: 21.03.01
    ...
    */
    ...
    sprintf(str_pass,"Your %s begin ",your_hand(1));
    if (!you.confusing_touch)
      strcat(str_pass,"to glow red.");
    else
      strcat(str_pass,"to glow brighter.");  
