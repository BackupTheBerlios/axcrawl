...
int mons_class_resist_mag( int mtype);
...
int mons_class_res_cold( int mtype);
...
int mons_class_res_elec( int mtype);
...
int mons_class_res_fire( int mtype);
...
int mons_class_res_poison( int mtype);
int mons_res_negative_energy( struct monsters *mon );
int mons_class_res_negative_energy( int mtype);
...
extern FixedVector < int, NUM_MONSTERS > mon_entry;
