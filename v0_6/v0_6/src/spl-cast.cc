 ...
 *  
 *  <5>     15.11.01    Alx    .- changed interfaz when asking spell to cast 
 *                             .- possible bug that could forbide undead to cast spells
 *                                because the hunger status
 *
...
void mini_list_spells(void); //alex:15.11.01
...
void cast_a_spell(void)
{
    ...
    for (;;)
    {
        //--- {alex:15.11.01}
        mini_list_spells(); 
        sprintf(str_pass,"Cast which spell? [a-%c] spell [?|*] list",'a'+you.spell_no-1);
        mpr(str_pass, MSGCH_PROMPT);        
        //----
        
        keyin = get_ch();
        mesclr(); //alex:15.11.01
    ...
    //Undead have hunger_state=0, without this "if", 
    //the second "if" always forbids mumies to cast spells
    if (you.is_undead != US_UNDEAD) //alex:23.01.02
      {
 ...
 */
    ...
    case SPTYP_CONJURATION:
        ...
        case 0:         // just a harmless message
            ...
            {
            case 0:
                snprintf( info, INFO_SIZE, "Sparks fly from your %s!", your_hand(1));
		 		mpr(info);
		 		break;
            case 1:
        ...
        case 1:         // a bit less harmless stuff
            ...
            {
            case 0:
                snprintf( info, INFO_SIZE, "Smoke pours from your %s!", your_hand(1));
	 		    mpr(info);
    ...
    case SPTYP_ENCHANTMENT:
        ...
        case 0:         // harmless messages only
            ...
            {
            case 0:
                snprintf( info, INFO_SIZE, "Your %s glow momentarily.", your_hand(1));
                mpr(info);
                break;
            case 1:
                mpr("The air around you crackles with energy!");
    ...
    case SPTYP_ICE:
        ...
        case 0:         // just a harmless message
            ...
            case 3:
                ...
                break;
            case 4:
		       snprintf( info, INFO_SIZE,"Your %s feel numb with cold.", your_hand(1));
		       mpr(info);
                break;
            case 5:
                mpr("A chill runs through your body.");
    ...
    case SPTYP_EARTH:
        ...
        case 1:
            ...
            case 1:
                ...
                break;
            case 2:
                snprintf( info, INFO_SIZE,"Sand pours from your %s.", your_hand(1));
		 		 mpr(info);
                break;
            case 3:
...
//Shows a list of spells below the message "Cast which spell..."
//Up to now, it only shows the 14 first spells
//Alex: 15.11.01
void mini_list_spells(void)
{
    int j,ft;
    ...
    for (j = 0; j < 25 && ncount<14; j++)
    {
        ...
        if (you.spells[j] != SPELL_NO_SPELL)
        {
            ...
            if (ncount<7)
                 ...
                 gotoxy(45,nrow++);            
            if (ncount==7) nrow=NUMBER_OF_LINES-6;     
