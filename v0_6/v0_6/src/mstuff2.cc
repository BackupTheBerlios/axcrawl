...
void setup_dragon(struct monsters *monster, struct bolt &pbolt)
{
    ...
    case MONS_XTAHUA:
        ...
        pbolt.colour = RED;
        pbolt.thrower=KILLED_BY_BREATHING_FLAMES; //alex:20.03.02
        break;
    ...
    case MONS_ICE_DRAGON:
        ...
        pbolt.colour = WHITE;
        pbolt.thrower=KILLED_BY_BREATHING_COLD; //alex:20.03.02
        break;
    ...
    pbolt.hit = 30;
    pbolt.beam_source = monster_index(monster);
//    pbolt.thrower = KILL_MON; {alex:20.03.02}
    pbolt.isBeam = true;
...
//  pbolt.thrower = KILL_MON_MISSILE; {alex:21.03.02}
    pbolt.thrower = KILLED_BY_MON_MISSILE;
    pbolt.isBeam = false;
}
...
bool mons_throw(struct monsters *monster, struct bolt &pbolt, int hand_used)
{
    ...
    //already set in setup_generic_throw() {alex:21.03.02} 
    //pbolt.range = 9;
    //pbolt.beam_source = monster_index(monster);
...
void spore_goes_pop(struct monsters *monster)
{
    ...
    if (type == MONS_GIANT_SPORE)
    {
        ...
        beam.thrower=KILLED_BY_SPORE; //{alex:21.03.02}
    }
    else
    {
        ...
        beam.thrower=KILLED_BY_ELECTRICITY; //{alex:21.03.02}
    }
...
struct SBeam mons_spells( int spell_cast, int power )
{
    ...
    case MS_MMISSILE:
        ...
        beam.hit = 1500;
        beam.type = SYM_ZAP;
        beam.thrown = KILLED_BY_MMISSILE; //alex:20.03.02
    ...
    case MS_FLAME:
        ...
        beam.hit = 60;
        beam.type = SYM_ZAP;
        beam.thrown = KILLED_BY_FLAME; //alex:20.03.02
    ...
    case MS_FROST:
        ...
        beam.hit = 60;
        beam.type = SYM_ZAP;
        beam.thrown = KILLED_BY_FROST; //alex:20.03.02
    ...
    case MS_VENOM_BOLT:
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON; {alex:21.03.02}
        beam.thrown = KILLED_BY_VENOM_BOLT;
    ...
    case MS_FIRE_BOLT:
        ...
        beam.thrown=KILLED_BY_FIRE_BOLT; //alex:20.03.02
        beam.flavour = BEAM_FIRE;
    ...
    case MS_COLD_BOLT:
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON;
        beam.thrown = KILLED_BY_COLD_BOLT; //alex:20.03.02
        beam.flavour = BEAM_COLD;
        beam.hit = 8 + random2(power) / 80;     // hit
        beam.isBeam = true;
        break;
    ...
    case MS_LIGHTNING_BOLT:
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON;
        beam.thrown = KILLED_BY_LIGHTNING_BOLT; //alex:20.03.02
        beam.flavour = BEAM_ELECTRICITY;
    ...
    case MS_FIREBALL:
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON;
        beam.thrown=KILLED_BY_FIREBALL; //alex:20.03.02
    ...
    case MS_CRYSTAL_SPEAR:      // was splinters
        ...
        //beam.thrown = KILL_MON;
        beam.thrown=KILLED_BY_CRYSTAL_SPEAR; //alex:20.03.02
        beam.flavour = BEAM_MMISSILE;
    ...
    case MS_NEGATIVE_BOLT:      // negative energy
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON;
        beam.thrown=KILLED_BY_NEGATIVE_BOLT; //alex:20.03.02
    ...
    case MS_ORB_ENERGY: // mystic blast
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON_MISSILE;
        beam.thrown=KILLED_BY_ORB_ENERGY;//alex:20.03.02
        beam.flavour = BEAM_MMISSILE;
        beam.isBeam = false;
        break;
    ...
    case MS_STEAM_BALL:
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON_MISSILE;
        beam.thrown=KILLED_BY_STEAM_BALL;//alex:20.03.02
    ...
    case MS_PAIN:
        ...
        //beam.thrown = KILL_MON;
        beam.thrown=KILLED_BY_PAIN;//alex:20.03.02
    ...
    case MS_STICKY_FLAME:
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON_MISSILE;
        beam.thrown=KILLED_BY_STICKY_FLAME;//alex:20.03.02
        beam.flavour = BEAM_FIRE;
        beam.isBeam = false;
        break;
    ...
    case MS_POISON_BLAST:       // demon
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON;
        beam.thrown=KILLED_BY_POISON_BLAST;//alex:20.03.02
        beam.flavour = BEAM_POISON;
        beam.hit = 7 + random2(power) / 80;
        beam.isBeam = true;
        break;
    ...
    case MS_PURPLE_BLAST:       // purple bang thing
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON_MISSILE;
        beam.thrown=KILLED_BY_PURPLE_BLAST;//alex:20.03.02
    ...
    case MS_ENERGY_BOLT:        // eye of devastation
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON_MISSILE;
        beam.thrown=KILLED_BY_ENERGY_BOLT;//alex:20.03.02
    ...
    case MS_STING:              // sting
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON_MISSILE;
        beam.thrown=KILLED_BY_STING;//alex:20.03.02
        beam.flavour = BEAM_POISON;
        beam.isBeam = false;
        break;
    ...
    case MS_IRON_BOLT:
        ...
        beam.type = SYM_MISSILE;
        //beam.thrown = KILL_MON_MISSILE;
        beam.thrown=KILLED_BY_IRON_BOLT;//alex:20.03.02
    ...
    case MS_POISON_SPLASH:
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON_MISSILE;
        beam.thrown=KILLED_BY_POISON_SPLASH;//alex:20.03.02
        beam.flavour = BEAM_POISON;
        beam.isBeam = false;
        break;
    ...
    case MS_DISINTEGRATE:
        ...
        //beam.thrown = KILL_MON;
        beam.thrown=KILLED_BY_DISINTEGRATE;//alex:20.03.02
        beam.ench_power = 50;
    ...
    case MS_MARSH_GAS:          // swamp drake
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON;
        beam.thrown=KILLED_BY_MARSH_GAS;//alex:20.03.02
        beam.flavour = BEAM_POISON;
        beam.hit = 7 + random2(power) / 80;
        beam.isBeam = false;
        break;
    ...
    case MS_QUICKSILVER_BOLT:   // Quicksilver dragon
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON_MISSILE;
        beam.thrown=KILLED_BY_QUICKSILVER_BOLT;//alex:20.03.02
        beam.flavour = BEAM_MMISSILE;
        beam.isBeam = false;
        break;
    ...
    case MS_HELLFIRE:           // fiend's hellfire
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON;
        beam.thrown=KILLED_BY_HELLFIRE;//alex:20.03.02
    ...
    case MS_METAL_SPLINTERS:
        ...
        beam.type = SYM_ZAP;
        //beam.thrown = KILL_MON;
        beam.thrown=KILLED_BY_METAL_SPLINTERS;//alex:20.03.02
